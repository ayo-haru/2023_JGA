...
public class BoothAnimalManager : SingletonMonoBehaviour<BoothAnimalManager>
{
    ...
    void Start()
	{
        ...
        penguinObj = PrefabContainerFinder.Find(ref GameData.animalDatas, "Penguin.prefab");
		...
		bearObj = PrefabContainerFinder.Find(ref GameData.animalDatas, "Bear.prefab");
        ...
        polarBearObj = PrefabContainerFinder.Find(ref GameData.animalDatas, "PolarBear.prefab");
        ...
        pandaObj = PrefabContainerFinder.Find(ref GameData.animalDatas, "Panda.prefab");
